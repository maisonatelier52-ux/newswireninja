    ...
    <main className="mx-auto max-w-7xl px-4 sm:px-6 py-16 md:py-24 font-serif bg-white min-h-screen">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="border-b-2 border-black pb-8 mb-14">
          ...
          {/* FIXED: Removed <br /> — it caused SEO tester to merge "GET IN" + "TOUCH."
              into one word "intouch", failing the H1 coherence keyword check.
              Now written as "Get in Touch" so keywords match page title & body text. */}
          ...
          <p className="mt-6 text-base text-gray-600 max-w-xl leading-relaxed">
            ...
            confidential sources are always protected. Get in touch with our
            editorial team today.
          </p>
        </div>
